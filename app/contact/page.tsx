...
export const metadata: Metadata = {
  ...
  description:
    "Connect with Binh Vu for collaboration opportunities, project inquiries, and technical discussions. Software developer based in Bhubaneswar, Odisha, India. Available for development projects, API development, and machine learning collaborations. Response time less than 24 hours.",
  keywords: [
  ...
  openGraph: {
    title: "Contact | Get in Touch with Software Developer",
    description:
      "Connect with Binh Vu for collaboration opportunities. Available for full-stack development, API development, and machine learning projects. Based in Bhubaneswar, Odisha, India.",
    type: "website",
    url: "https://billyvu.nimo.io.vn/contact",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Binh Vu - Contact Software Developer",
        type: "image/jpeg",
      },
    ],
  },
  twitter: {
    ...
    title: "Contact | Get in Touch with Software Developer",
    description:
      "Connect with Binh Vu for project collaborations and development opportunities. Available for hire.",
  ...
  alternates: {
    canonical: "https://billyvu.nimo.io.vn/contact",
    languages: {
      en: "https://billyvu.nimo.io.vn/contact",
    },
  },
  category: "Technology",
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "Contact",
      item: "https://billyvu.nimo.io.vn/contact",
    },
  ],
};
